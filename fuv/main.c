...
#define CHECK_UV_RESULT_AND_CLEANUP_REQ(R,REQ,WHO,EXE,PD) if((R)<0){cleanup_req((REQ));raiseUvError((WHO),(R),(EXE),PD);}

#define CHECK_UV_RESULT_AND_CLEANUP_HANDLE(R,HANDLE,LOOP,WHO,EXE,PD) if((R)<0){cleanup_handle((HANDLE),(LOOP));raiseUvError((WHO),(R),(EXE),PD);}
...
static int fuv_make_timer(FKL_CPROC_ARGL)
{
	...
	CHECK_UV_RESULT_AND_CLEANUP_HANDLE(r,timer_obj,loop_obj,Pname,exe,ctx->pd);
...
static int fuv_make_prepare(FKL_CPROC_ARGL)
{
	...
	CHECK_UV_RESULT_AND_CLEANUP_HANDLE(r,prepare_obj,loop_obj,Pname,exe,ctx->pd);
...
static int fuv_make_idle(FKL_CPROC_ARGL)
{
	...
	CHECK_UV_RESULT_AND_CLEANUP_HANDLE(r,idle,loop_obj,Pname,exe,ctx->pd);
...
static int fuv_make_check(FKL_CPROC_ARGL)
{
	...
	CHECK_UV_RESULT_AND_CLEANUP_HANDLE(r,check,loop_obj,Pname,exe,ctx->pd);
...
static int fuv_make_signal(FKL_CPROC_ARGL)
{
	...
	CHECK_UV_RESULT_AND_CLEANUP_HANDLE(r,signal,loop_obj,Pname,exe,ctx->pd);
...
static int fuv_make_async(FKL_CPROC_ARGL)
{
	...
	CHECK_UV_RESULT_AND_CLEANUP_HANDLE(r,async,loop_obj,Pname,exe,ctx->pd);
...
static int fuv_getaddrinfo(FKL_CPROC_ARGL)
{
	...
	else
	{
		...
		CHECK_UV_RESULT_AND_CLEANUP_REQ(r,retval,Pname,exe,ctx->pd);
...
static int fuv_process_spawn(FKL_CPROC_ARGL)
{
	...
	CHECK_UV_RESULT_AND_CLEANUP_HANDLE(uv_err,retval,loop_obj,Pname,exe,ctx->pd);
	FKL_VM_PUSH_VALUE(exe,retval);
	return 0;
}
...
static int fuv_stream_write(FKL_CPROC_ARGL)
{
	...
	free(bufs);
	CHECK_UV_RESULT_AND_CLEANUP_REQ(ret,write_obj,Pname,exe,ctx->pd);
...
static int fuv_stream_shutdown(FKL_CPROC_ARGL)
{
	...
	CHECK_UV_RESULT_AND_CLEANUP_REQ(ret,shutdown_obj,Pname,exe,ctx->pd);
...
static int fuv_make_pipe(FKL_CPROC_ARGL)
{
	...
	CHECK_UV_RESULT_AND_CLEANUP_HANDLE(r,retval,loop_obj,Pname,exe,ctx->pd);
	FKL_VM_PUSH_VALUE(exe,retval);
	return 0;
}
...
static int fuv_pipe_connect(FKL_CPROC_ARGL)
{
	...
	CHECK_UV_RESULT_AND_CLEANUP_REQ(ret,connect_obj,Pname,exe,ctx->pd);
...
static int fuv_udp_recv_stop(FKL_CPROC_ARGL)
{
	...
	FKL_CHECK_REST_ARG(exe,Pname);
	FKL_CHECK_TYPE(udp_obj,isFuvUdp,Pname,exe);
...
{
	static const char Pname[]="fuv.udp-open";
	FKL_DECL_AND_CHECK_ARG2(udp_obj,sock_obj,exe,Pname);
	FKL_CHECK_REST_ARG(exe,Pname);
	FKL_CHECK_TYPE(udp_obj,isFuvUdp,Pname,exe);
	FKL_CHECK_TYPE(sock_obj,fklIsVMint,Pname,exe);
	DECL_FUV_HANDLE_UD_AND_CHECK_CLOSED(udp_ud,udp_obj,Pname,exe,ctx->pd);
...
{
	static const char Pname[]="fuv.udp-multicast-loop-set!";
	FKL_DECL_AND_CHECK_ARG2(udp_obj,on_obj,exe,Pname);
	FKL_CHECK_REST_ARG(exe,Pname);
	FKL_CHECK_TYPE(udp_obj,isFuvUdp,Pname,exe);
	DECL_FUV_HANDLE_UD_AND_CHECK_CLOSED(udp_ud,udp_obj,Pname,exe,ctx->pd);
	uv_udp_t* udp=(uv_udp_t*)GET_HANDLE(*udp_ud);
...
{
	static const char Pname[]="fuv.udp-multicast-ttl-set!";
	FKL_DECL_AND_CHECK_ARG2(udp_obj,ttl_obj,exe,Pname);
	FKL_CHECK_REST_ARG(exe,Pname);
	FKL_CHECK_TYPE(udp_obj,isFuvUdp,Pname,exe);
	FKL_CHECK_TYPE(ttl_obj,FKL_IS_FIX,Pname,exe);
	DECL_FUV_HANDLE_UD_AND_CHECK_CLOSED(udp_ud,udp_obj,Pname,exe,ctx->pd);
	uv_udp_t* udp=(uv_udp_t*)GET_HANDLE(*udp_ud);
...
{
	static const char Pname[]="fuv.udp-multicast-interface-set!";
	FKL_DECL_AND_CHECK_ARG(udp_obj,exe,Pname);
...
{
	static const char Pname[]="fuv.udp-broadcast-set!";
	FKL_DECL_AND_CHECK_ARG2(udp_obj,on_obj,exe,Pname);
	FKL_CHECK_REST_ARG(exe,Pname);
	FKL_CHECK_TYPE(udp_obj,isFuvUdp,Pname,exe);
	DECL_FUV_HANDLE_UD_AND_CHECK_CLOSED(udp_ud,udp_obj,Pname,exe,ctx->pd);
...
{
	static const char Pname[]="fuv.udp-ttl-set!";
	FKL_DECL_AND_CHECK_ARG2(udp_obj,ttl_obj,exe,Pname);
	FKL_CHECK_REST_ARG(exe,Pname);
	FKL_CHECK_TYPE(udp_obj,isFuvUdp,Pname,exe);
	FKL_CHECK_TYPE(ttl_obj,FKL_IS_FIX,Pname,exe);
...
{
	static const char Pname[]="fuv.udp-connect";
	FKL_DECL_AND_CHECK_ARG3(udp_obj,host_obj,port_obj,exe,Pname);
	FKL_CHECK_REST_ARG(exe,Pname);
	FKL_CHECK_TYPE(udp_obj,isFuvUdp,Pname,exe);
	DECL_FUV_HANDLE_UD_AND_CHECK_CLOSED(udp_ud,udp_obj,Pname,exe,ctx->pd);
	struct sockaddr_storage addr;
...
{
	static const char Pname[]="fuv.udp-bind";
	FKL_DECL_AND_CHECK_ARG3(udp_obj,host_obj,port_obj,exe,Pname);
	FKL_CHECK_TYPE(udp_obj,isFuvUdp,Pname,exe);
	FKL_CHECK_TYPE(host_obj,FKL_IS_STR,Pname,exe);
	FKL_CHECK_TYPE(port_obj,FKL_IS_FIX,Pname,exe);
...
{
	static const char Pname[]="fuv.udp-using-recvmmsg?";
	FKL_DECL_AND_CHECK_ARG(udp_obj,exe,Pname);
	FKL_CHECK_REST_ARG(exe,Pname);
	FKL_CHECK_TYPE(udp_obj,isFuvUdp,Pname,exe);
	DECL_FUV_HANDLE_UD_AND_CHECK_CLOSED(udp_ud,udp_obj,Pname,exe,ctx->pd);
...
{
	static const char Pname[]="fuv.udp-peername";
	FKL_DECL_AND_CHECK_ARG(udp_obj,exe,Pname);
	FKL_CHECK_REST_ARG(exe,Pname);
	FKL_CHECK_TYPE(udp_obj,isFuvUdp,Pname,exe);
	DECL_FUV_HANDLE_UD_AND_CHECK_CLOSED(udp_ud,udp_obj,Pname,exe,ctx->pd);
...
{
	static const char Pname[]="fuv.udp-sockname";
	FKL_DECL_AND_CHECK_ARG(udp_obj,exe,Pname);
	FKL_CHECK_REST_ARG(exe,Pname);
	FKL_CHECK_TYPE(udp_obj,isFuvUdp,Pname,exe);
	DECL_FUV_HANDLE_UD_AND_CHECK_CLOSED(udp_ud,udp_obj,Pname,exe,ctx->pd);
...
{
	static const char Pname[]="fuv.udp-membership-set!";
	...
	FKL_CHECK_REST_ARG(exe,Pname);
	FKL_CHECK_TYPE(udp_obj,isFuvUdp,Pname,exe);
	FKL_CHECK_TYPE(multicast_addr_obj,FKL_IS_STR,Pname,exe);
	FKL_CHECK_TYPE(membership_obj,FKL_IS_SYM,Pname,exe);
...
{
	static const char Pname[]="fuv.udp-source-membership-set!";
	FKL_DECL_AND_CHECK_ARG4(udp_obj
			,multicast_addr_obj
			,interface_addr_obj
			,source_addr_obj
	...
	FKL_CHECK_TYPE(udp_obj,isFuvUdp,Pname,exe);
	FKL_CHECK_TYPE(multicast_addr_obj,FKL_IS_STR,Pname,exe);
	FKL_CHECK_TYPE(source_addr_obj,FKL_IS_STR,Pname,exe);
	FKL_CHECK_TYPE(membership_obj,FKL_IS_SYM,Pname,exe);
	if(interface_addr_obj!=FKL_VM_NIL&&!FKL_IS_STR(interface_addr_obj))
		FKL_RAISE_BUILTIN_ERROR_CSTR(Pname,FKL_ERR_INCORRECT_TYPE_VALUE,exe);
	DECL_FUV_HANDLE_UD_AND_CHECK_CLOSED(udp_ud,udp_obj,Pname,exe,ctx->pd);
...
{
	static const char Pname[]="fuv.udp-send";
	FKL_DECL_AND_CHECK_ARG4(udp_obj,host_obj,port_obj,cb_obj,exe,Pname);
	FKL_CHECK_TYPE(udp_obj,isFuvUdp,Pname,exe);
	if(cb_obj==FKL_VM_NIL)
		cb_obj=NULL;
	else if(!fklIsCallable(cb_obj))
	...
	free(bufs);
	CHECK_UV_RESULT_AND_CLEANUP_REQ(ret,udp_send_obj,Pname,exe,ctx->pd);
...
static void fuv_udp_recv_cb_value_creator(FklVM* exe,void* a)
{
	...
	FklVMvalue* err=nread<0
		?createUvErrorWithFpd("fuv.udp-recv-start",nread,exe,arg->fpd)
		:FKL_VM_NIL;
...
{
	static const char Pname[]="fuv.udp-recv-start";
	FKL_DECL_AND_CHECK_ARG2(udp_obj,cb_obj,exe,Pname);
	FKL_CHECK_REST_ARG(exe,Pname);
	FKL_CHECK_TYPE(udp_obj,isFuvUdp,Pname,exe);
	FKL_CHECK_TYPE(cb_obj,fklIsCallable,Pname,exe);
	DECL_FUV_HANDLE_UD_AND_CHECK_CLOSED(udp_ud,udp_obj,Pname,exe,ctx->pd);
...
{
	static const char Pname[]="fuv.udp-try-send";
	FKL_DECL_AND_CHECK_ARG3(udp_obj,host_obj,port_obj,exe,Pname);
	FKL_CHECK_TYPE(udp_obj,isFuvUdp,Pname,exe);
	DECL_FUV_HANDLE_UD_AND_CHECK_CLOSED(udp_ud,udp_obj,Pname,exe,ctx->pd);
