...
void fklUpdatePrototype(FklFuncPrototypes* cp,FklCodegenEnv* env,FklSymbolTable* globalSymTable);
...
void fklPrintUndefinedRef(const FklCodegenEnv* env,FklSymbolTable* globalSymTable);
