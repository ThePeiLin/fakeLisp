...
size_t ap=0;\
fklNiBegin(&ap,stack);
#define FKL_NI_CHECK_TYPE(V,P,ERR_INFO,FRAME,EXE) if(!P(V))FKL_RAISE_BUILTIN_ERROR_CSTR(ERR_INFO,FKL_ERR_INCORRECT_TYPE_VALUE,FRAME,EXE)
#define FKL_NI_CHECK_REST_ARG(PAP,STACK,ERR_INFO,FRAME,EXE) if(fklNiResBp((PAP),(STACK)))\
