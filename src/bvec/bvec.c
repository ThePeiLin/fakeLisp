...
}exports_and_func[]=
{
	...
	{"bytevector->s8-list",   export_bytevector_to_s8_list,   },
	{"bytevector->u8-list",   export_bytevector_to_u8_list,   },
	{"bytevector->s8-vector", export_bytevector_to_s8_vector, },
	{"bytevector->u8-vector", export_bytevector_to_u8_vector, },
};
