...
void B_push_in32(FakeVM*);
void B_push_in64(FakeVM*);
...
void B_push_fproc(FakeVM*);
void B_push_ptr_ref(FakeVM*);
void B_push_def_ref(FakeVM*);
void B_push_ind_ref(FakeVM*);
void B_push_ref(FakeVM*);
void B_pop(FakeVM*);
