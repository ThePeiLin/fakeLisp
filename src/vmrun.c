...
#define DLPROC(NAME) extern void NAME(FklVM*)
DLPROC(builtin_car);
DLPROC(builtin_cdr);
DLPROC(builtin_cons);
DLPROC(builtin_append);
DLPROC(builtin_atom);
DLPROC(builtin_null);
DLPROC(builtin_not);
DLPROC(builtin_eq);
DLPROC(builtin_equal);
DLPROC(builtin_eqn);
DLPROC(builtin_add);
DLPROC(builtin_add_1);
DLPROC(builtin_sub);
DLPROC(builtin_sub_1);
DLPROC(builtin_mul);
DLPROC(builtin_div);
DLPROC(builtin_rem);
DLPROC(builtin_gt);
...
DLPROC(builtin_le);
DLPROC(builtin_char);
DLPROC(builtin_integer);
DLPROC(builtin_f64);
DLPROC(builtin_as_str);
DLPROC(builtin_symbol);
DLPROC(builtin_nth);
DLPROC(builtin_length);
DLPROC(builtin_fopen);
DLPROC(builtin_read);
DLPROC(builtin_prin1);
DLPROC(builtin_princ);
DLPROC(builtin_dlopen);
DLPROC(builtin_dlsym);
DLPROC(builtin_argv);
DLPROC(builtin_go);
DLPROC(builtin_chanl);
DLPROC(builtin_send);
DLPROC(builtin_recv);
DLPROC(builtin_error);
DLPROC(builtin_raise);
DLPROC(builtin_call_cc);
DLPROC(builtin_apply);
DLPROC(builtin_reverse);
DLPROC(builtin_i32);
DLPROC(builtin_i64);
DLPROC(builtin_fclose);
DLPROC(builtin_feof);
DLPROC(builtin_vref);
DLPROC(builtin_nthcdr);
DLPROC(builtin_char_p);
DLPROC(builtin_integer_p);
DLPROC(builtin_i32_p);
DLPROC(builtin_i64_p);
DLPROC(builtin_f64_p);
DLPROC(builtin_pair_p);
DLPROC(builtin_symbol_p);
DLPROC(builtin_string_p);
DLPROC(builtin_error_p);
DLPROC(builtin_procedure_p);
DLPROC(builtin_proc_p);
DLPROC(builtin_dlproc_p);
DLPROC(builtin_vector_p);
DLPROC(builtin_chanl_p);
DLPROC(builtin_dll_p);
DLPROC(builtin_vector);
DLPROC(builtin_getdir);
DLPROC(builtin_fgetc);
DLPROC(builtin_fwrite);
DLPROC(builtin_to_str);
DLPROC(builtin_fgets);
DLPROC(builtin_parse_int);
DLPROC(builtin_parse_f64);
DLPROC(builtin_big_int_p);
DLPROC(builtin_big_int);
DLPROC(builtin_set_car);
DLPROC(builtin_set_cdr);
DLPROC(builtin_set_nth);
DLPROC(builtin_set_nthcdr);
DLPROC(builtin_set_vref);
DLPROC(builtin_list_p);
DLPROC(builtin_box);
DLPROC(builtin_unbox);
DLPROC(builtin_set_box);
DLPROC(builtin_cas_box);
DLPROC(builtin_box_p);
DLPROC(builtin_fix_int_p);
DLPROC(builtin_number_p);
DLPROC(builtin_map);
DLPROC(builtin_sref);
DLPROC(builtin_set_sref);
DLPROC(builtin_foreach);
DLPROC(builtin_andmap);
DLPROC(builtin_ormap);
DLPROC(builtin_list);
DLPROC(builtin_cas_vref);
DLPROC(builtin_memq);
DLPROC(builtin_member);
DLPROC(builtin_memp);

void fklInitGlobEnv(FklVMenv* obj,FklVMheap* heap)
{
	static const FklVMdllFunc builtInFunctionList[]=
	{
		builtin_car,
		builtin_cdr,
		builtin_cons,
	...
	fklFindOrAddVarWithValue(fklAddSymbolToGlobCstr(*(builtInSymbolList++))->id,FKL_VM_NIL,obj);
	fklFindOrAddVarWithValue(fklAddSymbolToGlobCstr(*(builtInSymbolList++))->id,VMstdin,obj);
	fklFindOrAddVarWithValue(fklAddSymbolToGlobCstr(*(builtInSymbolList++))->id,VMstdout,obj);
	fklFindOrAddVarWithValue(fklAddSymbolToGlobCstr(*(builtInSymbolList++))->id,VMstderr,obj);
	for(size_t i=0;*builtInSymbolList!=NULL;builtInSymbolList++,i++)
	{
		FklVMdlproc* proc=fklNewVMdlproc(builtInFunctionList[i],NULL);
		FklSymTabNode* node=fklAddSymbolToGlobCstr(*builtInSymbolList);
		proc->sid=node->id;
