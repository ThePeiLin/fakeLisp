...
inline void fklInitMainProcRefs(FklVMproc* mainProc,FklVM* exe)
{
	mainProc->count=exe->count;
	mainProc->closure=fklCopyMemory(exe->closure,sizeof(FklVMvalue*)*mainProc->count);
}
