...
inline FklInstruction* fklGetCompoundFrameCode(const FklVMframe* f)
{
	return f->c.pc;
}

inline FklOpcode fklGetCompoundFrameOp(FklVMframe* f)
{
	return (f->c.pc++)->op;
}
...
inline FklInstruction* fklGetCompoundFrameEnd(const FklVMframe* f)
{
	return f->c.end;
}
